...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = 
{
  ...
  [1] = LAYOUT_all(
  	  ...
  	  KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS, TG(_NUMPAD),      KC_TRNS,          KC_LEFT, KC_DOWN,          KC_RIGHT ),

  [2] = LAYOUT_all(
                                                                                                                  KC_TRNS,
  	  KC_ESC,           KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_DEL,
  	  KC_CAPS,          KC_F11,  KC_F12,  KC_F13,  KC_F14,  KC_F15,  KC_F16,  KC_F17,  KC_F18,  KC_F19,  KC_F20,  KC_PSCR,
  	  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_INS,  KC_HOME, KC_END,           KC_PGUP,
  	  KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS, KC_APP,           KC_TRNS,          KC_TRNS, KC_TRNS,          KC_PGDN ),

  [3] = LAYOUT_all(
                                                                                                                  KC_TRNS,
  	  KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_P7,   KC_P8,   KC_P9,   KC_PSLS, KC_DEL,  KC_BSPC,
  	  KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_P4,   KC_P5,   KC_P6,   KC_PAST, KC_ENT,  KC_ENT,
      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_P1,   KC_P2,   KC_P3,   KC_PMNS,          KC_ENT,
  	  KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS, KC_TRNS,          KC_P0,            KC_PDOT, KC_PPLS,          KC_TRNS )
};
...
bool encoder_update_user(uint8_t index, bool clockwise) {
    switch (index) {
		case 0:
			if ( clockwise ) 
			{
				if (selected_layer  < 4 && keyboard_report->mods & MOD_BIT(KC_LCTL))
